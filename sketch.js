...
textSize(30);
fill("black")
text("Colten Wood is the last survivor in the zombie appcolypse(you), can you survive by making a defense against the zombies, will you be able to end the appcolypse?",popup1.x,popup1.y).visible=true;
...
if(gameState==="about"){
 ...
 /*   if(keyDown("space")&&player.isTouching(tree)){
    ...
    if(woodscore===15 && hutBuilt==="FALSE"){
      hut.visible=true;
